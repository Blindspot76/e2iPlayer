...
class IPTVSetupImpl:
    def __init__(self, finished, chooseQuestion, showMessage, setInfo):
        ...
        # rtmpdump members
        self.rtmpdumpVersion = {'armv5t':'2009-2015', 'armv7':'K-S-V patch', 'default':"Compiled by samsamsam@o2.pl 2015-01-11"}
        ...
        self._gstplayerInstallChoiseList = [(_('Install into the "%s".') % ("/usr/bin/gstplayer (%s)" % _("recommended")), "/usr/bin/gstplayer"),
                                          ...
                                          (_("Do not install (not recommended)"), "")]
        # exteplayer3
        self.exteplayer3Version = {'sh4': 9, 'mipsel': 24, 'armv7': 24, 'armv5t':24}
