...
class IPTVExtMoviePlayer(Screen):
    ...
    def __prepareSkin(self):
        ...
        if self.clockFormat:
            clockFontSize = 32 if getDesktop(0).size().width() == 1920 else 36
            clockWidget = '<widget name="clockTime" noWrap="1" position="35,129" size="100,40" zPosition="3" transparent="1" foregroundColor="#c8cedb" backgroundColor="#251f1f1f" font="Regular;%d" halign="center" valign="center" />' % clockFontSize
        else:
            clockWidget = ''
    ...
    def __init__(self, session, filesrcLocation, FileName, lastPosition=None, player='eplayer', additionalParams={}):
        ...
        try:
            self.playback['statusIcons']['Play']        = LoadPixmap( GetIPTVDMImgDir("playback_a_play_red.png") )
            self.playback['statusIcons']['Pause']       = LoadPixmap( GetIPTVDMImgDir("playback_a_pause_red.png") )
