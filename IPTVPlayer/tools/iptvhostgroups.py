...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_GROUPS = ["userdefined", "moviesandseries", "cartoonsandanime", "sport", "live", "documentary", "science", \
                                  "polish", "english", "german", "french", "russian", "hungarian", "greek", "latino", "italian", "others"]
        ...
        self.PREDEFINED_HOSTS['arabic']           = ['youtube','webstream','egybest','dardarkomcom','movs4ucom','movizlandcom','shahiidanimenet','dailymotion','twitchtv','hitboxtv']
