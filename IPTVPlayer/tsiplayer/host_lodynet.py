...
class TSIPHost(TSCBaseHostClass):
    def __init__(self):
        ...
        self.MAIN_URL = 'https://m.lodynet.art'
    ...
    def showmenu1(self,cItem):
        ...
        elif gnr == 1 : TAB = [('افلام هندية','/category/hindi-movie/','20',''),('أفلام هندية مدبلجة','/category/أفلام-هندية-مدبلجة/','20',''),('افلام تركية مترجم','/category/افلام-تركية-مترجم/','20',''),
