...
class TSIPHost(TSCBaseHostClass):
    def __init__(self):
        ...
        self.MAIN_URL = 'https://shahid4u.plus'
    ...
    def showmenu0(self,cItem):
        hst='host2'
        self.Arablionz_TAB = [
                            {'category':hst,'title': tscolor('\c0000????') + 'Ramadan 2021' ,'mode':'30', 'url': self.MAIN_URL+'/category/مسلسلات-رمضان-2021','sub_mode':'serie','page':1},
    ...
    def showmenu2(self,cItem):		
        ...
        if gnr=='film': 
            ...
            self.addDir({'import':cItem['import'],'category' : 'host2','url': self.MAIN_URL+'/category/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%AA%D8%B1%D9%83%D9%8A-1','title':'مسلسلات تركية','desc':'','page':1,'icon':img_,'sub_mode':gnr,'mode':'30'})		
                ...
                if (id_data and code_data):
                    for (x1,code_,titre_) in code_data:
                        ...
                        if 'السيرفر الخاص' in titre_:
                            ...
                            local = 'local'                        
                        urlTab.append({'name':titre_.strip(), 'url':'hst#tshost#'+url, 'need_resolve':1, 'type':local})
                else:
