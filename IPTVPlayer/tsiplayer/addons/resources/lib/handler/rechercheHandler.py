...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.lib.comaddon import addon, VSlog
...
class cRechercheHandler:
    ...
    def importPlugin(self, sName, sCat):
        ...
        try:
            plugin = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.sites.%s' % sName, fromlist=[sName])
