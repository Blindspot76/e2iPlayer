...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.lib.handler.siteHandler import cSiteHandler
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.lib.comaddon import addon, window
...
class cHome:
    ...
    def showUpdate(self):
        try:
            from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.lib.about import cAbout
