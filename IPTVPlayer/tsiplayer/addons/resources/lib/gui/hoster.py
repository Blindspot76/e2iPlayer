...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.lib.comaddon import dialog, addon, VSlog, xbmc
...
class cHosterGui:
    ...
    def getHoster(self, sHosterFileName):
        exec ("from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources.hosters." + sHosterFileName + " import cHoster", globals())
        return cHoster()
