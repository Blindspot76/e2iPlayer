...
#from Plugins.Extensions.IPTVPlayer.tsiplayer.libs.vstream.resources.lib.comaddon import addon, dialog, VSlog
    ...
    def __callRequest(self):
        ...
        try:
            ...
            if e.code == 503:
                ...
                from Plugins.Extensions.IPTVPlayer.tsiplayer.libs.vstream import cloudflare
