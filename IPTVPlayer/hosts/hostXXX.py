# -*- coding: utf-8 -*-
# Modified by Blindspot - 2022.05.17.
# Added new hosts: Pornhat, Motherless
###################################################
# LOCAL import
###################################################
...
#              valTab = valTab + valtemp
              ...
              #valtemp = self.listsItems(-1, url, 'MOTHERLESS-search')
              #for item in valtemp: item.name='MOTHERLESS - '+item.name
              #valTab = valTab + valtemp
