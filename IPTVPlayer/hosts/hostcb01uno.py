...
class Cb01(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.MAIN_URL = 'https://cb01.miami/'
        self.DEFAULT_ICON_URL = 'https://cb01.miami/wp-content/uploads/2019/03/logocb2-1.jpg'
    ...
    def listMainMenu(self, cItem):
        ...
        MAIN_CAT_TAB = [{'category':'search',          'title': _('Search'), 'search_item':True},
                        {'category':'search_history',  'title': _('Search-serie-tv')} ]
